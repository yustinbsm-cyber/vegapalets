...
const SUPABASE_URL = 'https://fqerxaichxdfkfjrbylj.supabase.co'; // CAMBIA ESTO
const SUPABASE_KEY = 'sb_publishable_e1BKW3J5RbziYe-sj6MKLA_h3LFnzp5'; // CAMBIA ESTO (ANON_KEY)
